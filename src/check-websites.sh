...
# contact:website tag
curl "https://overpass-api.de/api/interpreter?data=%5Bout%3Acsv%28%3A%3Atype%2C%3A%3Aid%2Ccontact:website%29%5D%5Btimeout%3A25%5D%3B%0Aarea%28id%3A${cur_IR}%29-%3E.searchArea%3B%0Anwr%5B%22contact:website%22%5D%28area.searchArea%29%3B%0Aout%20meta%3B" >>./tmp/"$1"_elements_website.lst
